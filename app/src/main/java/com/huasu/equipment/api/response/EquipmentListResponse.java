 ...
 * 设备列表响应
 */
public class EquipmentListResponse extends BaseResponse<List<EquipmentListResponse.EquipmentListItem>> {
    // 继承自 BaseResponse，data 为 List<EquipmentListItem>

    /**
     * 设备列表项
     */
    public static class EquipmentListItem implements Serializable {
