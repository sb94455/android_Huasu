 ...
 * 点检任务列表响应
 */
public class InspectionListResponse extends BaseResponse<List<InspectionListResponse.InspectionListItem>> {

    /**
     * 点检任务列表项
     */
    public static class InspectionListItem implements Serializable {
